...
// //     const block2 = chain.mineBlock(); // mine a block and now user1 can claim their stx rewards after poolOperator has sent rewards

// //     const block3 = chain.mineBlock([ccd007CityStacking.claimStackingReward(user1, miaCityName, 2)]); // this should fail because poolOperator hasn't sent rewards yet
